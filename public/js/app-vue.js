...
Vue.component('reclasificacion_costos-index', {
    ...
    mounted: function mounted() {
        ...
        self.dataTable = $('#solicitudes_table').DataTable({
            "createdRow": function createdRow(row, data, dataIndex) {
                if (data.estatus.estatus == -1) $(row).addClass('bg-red disabled');else if (data.estatus.estatus == 2) $(row).addClass('bg-green disabled');
            },
            "processing": true,
            "serverSide": true,
            "ordering": false,
    ...
    methods: {
        ...
        close_modal_pdf: function close_modal_pdf() {
