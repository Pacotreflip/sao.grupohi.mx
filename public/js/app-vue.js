...
Vue.component('variacion-insumos', {
    ...
    methods: {
        ...
        removeRendimiento: function removeRendimiento(id_concepto, id) {
            var valor = 0.0;
        ...
        recalcular: function recalcular(id_concepto, i) {
            var self = this;
        ...
        recalcular_monto: function recalcular_monto(id_concepto, i) {
            var self = this;
...
},{"./templates/errors.html":46}],43:[function(require,module,exports){
'use strict';
...
},{"./templates/global-errors.html":47}],44:[function(require,module,exports){
'use strict';
