...
@section('content-menu')
    <ul class="sidebar-menu">
        <li ><a href="{{route('modulo_contable.cuenta_contable.configuracion')}}"><i class='fa fa-bank'></i> <span>Configuración Contable</span></a></li>
        ...
        <li class="treeview">
            ...
            <ul class="treeview-menu">
                ...
                <li ><a href="{{route('modulo_contable.cuenta_material.index')}}"><i class='fa fa-book'></i> <span>Cuentas Materiales</span></a></li>
