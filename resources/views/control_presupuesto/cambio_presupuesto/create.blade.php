                ...
                <div class="col-md-12" v-if="form.id_tipo_orden != ''">
                    <div class="box box-solid">
                        <div class="box-header with-border">
                            ...
                            <div class="box-tools">
                                <button type="button" class="btn btn-sm btn-primary pull-right" data-toggle="modal" data-target="#agregar_filtro_modal" @click="validation_errors.clear('form_add_filtro')">Agregar Filtro</button>
                            </div>
                        </div>
