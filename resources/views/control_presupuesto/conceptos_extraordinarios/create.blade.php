                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="form-group" :class="{'has-error': validation_errors.has('form_save_solicitud.Concepto Cantidad')}">
                                                            <input type="text" step=".01" placeholder="Ingrese Cantidad" class="form-control" v-validate="'required|decimal:6|min_value:0|max_value:99999'"
                                                    ...
                                                    <tr v-for="(insumo, i) in form.extraordinario.MATERIALES.insumos" >
                                                        ...
                                                        <td>
                                                            <div class="form-group" :class="{'has-error': validation_errors.has('form_save_solicitud.Material Cantidad [' + (i + 1) + ']')}">
                                                                <input type="text" step=".01" placeholder="Ingrese Cantidad" v-validate="'required|decimal:6|min_value:0|max_value:99999'"
                                                        ...
                                                        <td>
                                                            <div class="form-group" :class="{'has-error': validation_errors.has('form_save_solicitud.Material Importe [' + (i + 1) + ']')}">
                                                               $ <input type="text" step=".01" placeholder="Ingrese Cantidad" v-validate="'required|decimal:3|min_value:0|max_value:999999999999'"
                                                ...
                                                <tr v-for="(insumo, i) in form.extraordinario.MANOOBRA.insumos" >
                                                    ...
                                                    <td>
                                                        <div class="form-group" :class="{'has-error': validation_errors.has('form_save_solicitud.Mano de Obra Cantidad [' + (i + 1) + ']')}">
                                                            <input type="text" step=".01" placeholder="Ingrese Cantidad" v-model="insumo.cantidad_presupuestada" style="width: 100%; height: 25px" v-validate="'required|decimal:6|min_value:0|max_value:99999'"
