...
@section('main-content')
    ...
    @if($polizas)
        <div class="row" style="float:right">
            <div class="col-sm-12">
                <button class="btn btn-sm btn-primary pull-right" data-toggle="modal"
                        data-target="#add_movimiento_modal" data-dismiss="modal">Acumulado
                </button>
            </div>
        </div>
        <br>
                                ...
                                @foreach($polizas as $index => $item)
                                    <tr>
                                        ...
                                        <td style="min-width: 90px;max-width: 90px">
                                            <a href="{{route('sistema_contable.poliza_generada.show',$item)}}"
                                               title="Ver"
                                            ...
                                            <a href="{{route('sistema_contable.poliza_generada.edit',$item)}}"
                                               title="Editar"
                                               class="btn btn-xs btn-info  {{$item->estatus==1||$item->estatus==2 ? 'disabled' : '' }}"><i
        ...
        <div id="add_movimiento_modal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="editCuentaModal"
