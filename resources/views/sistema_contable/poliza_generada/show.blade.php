                        ...
                        <table class="table table-bordered">
                            ...
                            <tr>
                                ...
                                <th class="bg-gray-light">
                                    Estatus:<br>
                                    <label>
                                        @if($poliza->estatus_string == 'Registrada') <span class="label bg-blue">Registrada</span>@endif
                                        ...
                                        @if($poliza->estatus_string == 'Con errores') <span class="label bg-red">Con errores</span>@endif
                                    </label>
                                </th>
                                <th class="bg-gray-light">
                                    Póliza Contpaq:
