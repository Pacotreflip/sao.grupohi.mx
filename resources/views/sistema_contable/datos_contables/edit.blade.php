                    ...
                    <div class="box box-info">
                        ...
                        <form id="form_datos_obra" @submit.prevent="validateForm('form_datos_obra', 'save_datos_obra')"  data-vv-scope="form_datos_obra">
                            <div class="box-body">
                                <div class="col-md-4">
                                    <div class="form-group" :class="{'has-error': validation_errors.has('form_datos_obra.Base de Datos CONTPAQ') }">
                                        ...
                                        <input type="text" v-validate="'required'" name="Base de Datos CONTPAQ" class="form-control" id="BDContPaq" v-model="data.datos_contables.BDContPaq" :disabled="data.datos_contables.BDContPaq">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group" :class="{'has-error': validation_errors.has('form_datos_obra.Numero de Obra CONTPAQ') }">
                                        ...
                                        <input type="number" v-validate="'required|numeric'" name="Numero de Obra CONTPAQ" class="form-control" id="NumobraContPaq" v-model="data.datos_contables.NumobraContPaq" :disabled="data.datos_contables.NumobraContPaq">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group" :class="{'has-error': validation_errors.has('form_datos_obra.Formato de Cuentas') }">
                                        ...
                                        <input type="text" v-validate="'required|regex:^\#[\#\-]+\#$'" name="Formato de Cuentas" class="form-control" id="FormatoCuenta" v-model="data.datos_contables.FormatoCuenta" :disabled="data.datos_contables.FormatoCuenta">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input type="radio" class="radio-inline" name="manejo_si" value="1" id="manejo_si" v-model="data.datos_contables.manejo_almacenes" :disabled="data.datos_contables" />
                                        <label for="y">Si</label>
                                        <input type="radio" class="radio-inline" name="manejo_no" value="0" id="manejo_no" v-model="data.datos_contables.manejo_almacenes" :disabled="data.datos_contables" />
                                        <label for="z">No</label>
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <label class="control-label"><b>¿Tendrá Costo por tipo de gasto?</b></label><br>
                                        <input type="radio" class="radio-inline" name="gasto_si" value="1" id="gasto_si" v-model="data.datos_contables.costo_en_tipo_gasto" :disabled="data.datos_contables" />
                                        <label for="y">Si</label>
                                        <input type="radio" class="radio-inline" name="gasto_no" value="0" id="gasto_no" v-model="data.datos_contables.costo_en_tipo_gasto" :disabled="data.datos_contables" />
                                        <label for="z">No</label>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="box-footer">
                                <div class="col-md-12" v-show="!data.datos_contables">
