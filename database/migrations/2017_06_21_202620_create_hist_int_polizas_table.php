...
class CreateHistIntPolizasTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('contabilidad.hist_int_polizas', function (Blueprint $table) {
            $table->increments('id_hist_int_poliza');
    ...
    {
        Schema::drop('contabilidad.hist_int_polizas');
    }
}
