...
class CreateContabilidadUdfObtieneRetencionesFunction extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        \DB::statement('-- =============================================
                        ...
                        -- =============================================
                        CREATE FUNCTION [Contabilidad].[udfObtieneRetenciones]
                        (
                          @id_transaccion INT
                        )
                        RETURNS FLOAT
                        ...
                        GROUP BY transacciones.id_transaccion,
                         ...
                         SELECT 
                              @retenciones = SUM (isnull (retencion.importe, 0))
    ...
    {
        \DB::statement('DROP FUNCTION [Contabilidad].[udfObtieneRetenciones]');
    }
}
