...
class AddIdSolicitudReclasificacionPartidaToIntPolizasMovimientos extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    {
        Schema::table('Contabilidad.int_polizas_movimientos', function (Blueprint $table) {
            $table->dropForeign('contabilidad_int_polizas_movimientos_id_solicitud_reclasificacion_partida_foreign');
