...
class CreateContabilidadGeneraMovimientosDevolucionRetencionesProcedure extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        \DB::statement('-- =============================================
                        ...
                        -- la devolución de otras retenciones de subcontratos registrados 
                        -- desde el módulo de estimaciones 
                        -- =============================================
                        CREATE PROCEDURE [Contabilidad].[generaMovimientosDevolucionRetencionesSubcontratos] 
                          @id_int_poliza INT
                        AS
                        BEGIN
                          ...
                          SELECT @importe = [Contabilidad].[udfObtieneDevolucionRetenciones](@id_transaccion)
                          ...
                          INSERT INTO [Contabilidad].[int_polizas_movimientos]
                            ...
                            ,[referencia]
                              ...
                              SELECT 
                               ...
                               37 AS id_tipo_cuenta_contable, --cuenta del catálogo de cuentas generales
                              Contabilidad.udfGetCuentaEmpresa(
                                transacciones.id_obra,
                                transacciones.id_empresa,
                                1,
                                10
                              ) AS cuenta_contable,       --la función consudera el id de cuenta de empresa 
                        ...
                        LEFT JOIN
                         ...
                         PRINT \'Movimientos de Devolución de Retenciones de Subcontratos Registrados:\' +  CAST( @cantidad_movimientos AS VARCHAR(10) );
    ...
    {
        \DB::statement('DROP PROCEDURE [Contabilidad].[generaMovimientosDevolucionRetencionesSubcontratos]');
    }
}
