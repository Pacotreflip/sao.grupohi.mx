...
class AddForeignkeyToHistIntPolizasMovimientos extends Migration
{
    ...
    public function up()
    {
        Schema::table('contabilidad.hist_int_polizas_movimientos', function (Blueprint $table) {
            $table->foreign('id_int_poliza_movimiento')->references(' id_int_poliza_movimiento')->on('contabilidad.int_polizas_movimientos');
    ...
    {
        Schema::table('contabilidad.hist_int_polizas_movimientos', function (Blueprint $table) {
            $table->dropForeign('contabilidad.hist_int_polizas_movimientos_int_poliza_movimientos_id_foreign');
