...
class AddForeignkeyToHistIntPolizasMovimientos extends Migration
{
    ...
    {
        Schema::table('contabilidad.hist_int_polizas_movimientos', function (Blueprint $table) {
            $table->dropForeign('contabilidad_hist_int_polizas_movimientos_id_cuenta_contable_foreign');
            $table->dropForeign('contabilidad_hist_int_polizas_movimientos_id_hist_int_poliza_foreign');
            $table->dropForeign('contabilidad_hist_int_polizas_movimientos_id_int_poliza_foreign');
            $table->dropForeign('contabilidad_hist_int_polizas_movimientos_id_tipo_cuenta_contable_foreign');
            $table->dropForeign('contabilidad_hist_int_polizas_movimientos_id_tipo_movimiento_poliza_foreign');
