...
class CreateContabilidadGeneraMovimientosAnticipoMaterialesProcedure extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        \DB::statement('-- =============================================
                        ...
                        -- de anticipo de materiales
                        -- =============================================
                        CREATE PROCEDURE [Contabilidad].[generaMovimientosAnticipoMateriales]
                          @id_int_poliza INT
                        AS
                        BEGIN
    ...
    {
        \DB::statement('DROP PROCEDURE [Contabilidad].[generaMovimientosAnticipoMateriales]');
    }
}
