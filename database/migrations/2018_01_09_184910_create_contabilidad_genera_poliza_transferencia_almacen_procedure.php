...
class CreateContabilidadGeneraPolizaTransferenciaAlmacenProcedure extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        \DB::statement('-- =============================================
                        ...
                        -- =============================================
                        CREATE PROCEDURE [Contabilidad].[generaPolizaTransferenciaAlmacen] 
                          @id_transaccion INT
                        AS
                        BEGIN
                          ...
                          SELECT 2 AS id_tipo_poliza,
                               391 AS id_tipo_poliza_interfaz,
                             ...
                             LEFT(\'*TA # \' + cast(transacciones.numero_folio as varchar(10))+\'* (\' + isnull(transacciones.observaciones,\'\')+\')\', 100) AS concepto,
                          ...
                          FROM ((dbo.items items
                                 INNER JOIN dbo.inventarios
                                    ON (items.id_item = inventarios.id_item))
                                RIGHT OUTER JOIN
                         ...
                         WHERE     (transacciones.id_transaccion = @id_transaccion)
                               ...
                               AND (transacciones.opciones = 65537)
                        ...
                        PRINT \'Pólizas de transferencia de almacén registradas: \' + 
                        ...
                        29 AS id_tipo_cuenta_contable,
                          ...
                          FROM (((dbo.items items
                              ...
                              WHERE cuentas_almacenes.estatus = 1)
                               Subquery
                                  ON (items.id_almacen = Subquery.id_almacen)
    ...
    {
        \DB::statement('DROP PROCEDURE [Contabilidad].[generaPolizaTransferenciaAlmacen]');
    }
}
