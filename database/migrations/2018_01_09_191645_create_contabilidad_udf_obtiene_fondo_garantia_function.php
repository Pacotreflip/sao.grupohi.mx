...
class CreateContabilidadUdfObtieneFondoGarantiaFunction extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        \DB::statement('-- =============================================
                        ...
                        -- Description: Función para obtener el fondo de garantía
                        -- de las estimaciones relacionadas con la factura en cuestión,
                        -- la información se toma del módulo WEB de Estimaciones puede venir en 0
                        -- =============================================
                        CREATE FUNCTION [Contabilidad].[udfObtieneFondoGarantia]
                        (
                          @id_transaccion INT
                        )
                        RETURNS FLOAT
                        ...
                        GROUP BY transacciones.id_transaccion,
                         ...
                         SELECT 
                              @fondo_garantia = SUM (Estimaciones.ImporteFondoGarantia)
    ...
    {
        \DB::statement('DROP FUNCTION [Contabilidad].[udfObtieneFondoGarantia]');
    }
}
